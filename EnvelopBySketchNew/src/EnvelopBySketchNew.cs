...
{
      public static class EnvelopBySketchNew
    {
        /// <summary>
        ...
        /// <returns>A EnvelopBySketchNewOutputs instance containing computed results and the model with any new elements.</returns>
        public static EnvelopBySketchNewOutputs Execute(Dictionary<string, Model> inputModels, EnvelopBySketchNewInputs input)
        {
            ...
            var output = new EnvelopBySketchNewOutputs(input.BuildingHeight, input.FoundationDepth);
