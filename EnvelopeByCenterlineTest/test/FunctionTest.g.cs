...
namespace EnvelopeByCenterlineTest.Tests
{
    public class FunctionTests
    {
        ...
        public async Task InvokeFunction()
        {
            ...
            var store = new FileModelStore<EnvelopeByCenterlineTestInputs>(root, true);

            // Create an input object with default values.
            var input = new EnvelopeByCenterlineTestInputs();
