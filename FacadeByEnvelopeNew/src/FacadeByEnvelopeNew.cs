...
namespace FacadeByEnvelopeNew
{
    internal class LevelComparer : IComparer<Level>
    {
      ...
      public static class FacadeByEnvelopeNew
    {
        ...
        /// <returns>A FacadeByEnvelopeNewOutputs instance containing computed results and the model with any new elements.</returns>
        public static FacadeByEnvelopeNewOutputs Execute(Dictionary<string, Model> models, FacadeByEnvelopeNewInputs input)
        {
            ...
            var output = new FacadeByEnvelopeNewOutputs(panelCount);
            output.Model = model;
            return output;
        }
