...
namespace InputTest
{
    public class Function
    {
        ...
        private IModelStore<InputTestInputs> store;

        public async Task<InputTestOutputs> Handler(InputTestInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<InputTestInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
            }

            var l = new InvocationWrapper<InputTestInputs,InputTestOutputs>(store, InputTest.Execute);
