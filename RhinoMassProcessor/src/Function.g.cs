...
namespace RhinoMassProcessor
{
    public class Function
    {
        ...
        private IModelStore<RhinoMassProcessorInputs> store;

        public async Task<RhinoMassProcessorOutputs> Handler(RhinoMassProcessorInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<RhinoMassProcessorInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
            }

            var l = new InvocationWrapper<RhinoMassProcessorInputs,RhinoMassProcessorOutputs>(store, RhinoMassProcessor.Execute);
